...
<head>
  ...
  <title>Mume.com Yönetim Paneli </title>
      ...
      <div class="animate form login_form">
        <section class="login_content">
          ...
          <form action="../netting/islem.php" method="POST">
            ...
            <div>
              <input type="text" name="admin_email" class="form-control" placeholder="Kullanıcı Adınız (Mail)" required="" />
            </div>
            <div>
            ...
            <div class="separator">
             ...
             ?>
              ...
              <div>
                <h1><i class="fa fa-paw"></i> Hukuk Danışmanlık</h1>
                <p>©2019 By Y.A</p>
              </div>
            </div>
          </form>
